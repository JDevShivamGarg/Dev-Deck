...
const styles = StyleSheet.create({
  ...
  accuracyLabel: { color: colors.onSurface, fontFamily: 'SpaceGrotesk_700Bold', fontSize: 12, letterSpacing: 1.2, textTransform: 'uppercase', flex: 1, marginRight: 8 },
  ...
  logLeft: { flexDirection: 'row', alignItems: 'center', gap: 16, flex: 1, marginRight: 16 },
  logDate: { color: colors.onSurfaceVariant, fontFamily: 'monospace', fontSize: 14, width: 90 },
  logTopic: { color: colors.onSurface, fontFamily: 'SpaceGrotesk_700Bold', fontSize: 12, letterSpacing: 1.2, textTransform: 'uppercase', flex: 1 },
