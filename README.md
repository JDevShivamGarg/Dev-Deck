...
* **Hybrid AI Content Generation**: 
  * **Automatic Generation**: Connect your Groq API key to generate entire decks (MCQs, Flashcards, Scenario-based Questions) on-the-fly.
...
│   ├── (tabs)/           # Bottom tab navigation (Home, Profile, etc.)
│   ├── session/          # Active study session screens (MCQ, Flashcard, Setup)
│   └── topic/            # Topic creation and card generation screens
